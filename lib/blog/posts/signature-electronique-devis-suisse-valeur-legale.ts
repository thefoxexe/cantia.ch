...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    { type: 'h2', text: 'Ce qui rend une signature électronique simple solide' },
    {
      ...
      items: [
        ...
        'L’identification claire du document accepté (version, montant, date), et pas seulement un clic isolé sans contexte',
    ...
    },
    {
      ...
      text: 'Le portail client Cantia permet au client de consulter et signer son devis directement en ligne, avec une acceptation horodatée et conservée avec le document.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Uniquement pour les actes où la loi exige spécifiquement une forme écrite qualifiée. Il s’agit d’un cas rare qui ne concerne quasiment jamais un devis de travaux du bâtiment.',
    },
    {
