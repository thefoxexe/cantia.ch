...
export const post: BlogPost = {
  slug: 'logiciel-simple-debuter-independant-batiment',
  question: 'Comment trouver un logiciel de gestion vraiment simple pour débuter en tant qu\'indépendant du bâtiment ?',
  title: 'Un logiciel simple pour débuter, sans passer des heures à le comprendre',
  description:
  ...
  blocks: [
    ...
    { type: 'h2', text: 'Comment repérer un outil vraiment simple' },
    {
      type: 'list',
      items: [
        'Le premier devis peut être créé sans avoir besoin de configurer quoi que ce soit au préalable',
        'Les termes utilisés sont ceux du métier (devis, facture, chantier), pas un jargon logiciel abstrait',
        'Les fonctions avancées restent accessibles mais ne s\'imposent pas dès l\'écran d\'accueil',
        'Une aide contextuelle existe, mais n\'est jamais indispensable pour les tâches de base',
      ],
    },
    {
      type: 'stat',
      value: '< 10 min',
      label: 'temps généralement nécessaire pour créer un compte et envoyer un premier devis avec un outil réellement simple, sans formation préalable',
    },
    { type: 'h2', text: 'Simple ne veut pas dire limité' },
    {
      type: 'p',
      text: 'Un outil simple à démarrer peut très bien contenir des fonctions avancées (planning, RH, trésorerie) accessibles plus tard, sans qu\'elles n\'encombrent l\'expérience du début. La simplicité est une question de progressivité, pas d\'absence de fonctionnalités.',
    },
    {
      type: 'callout',
