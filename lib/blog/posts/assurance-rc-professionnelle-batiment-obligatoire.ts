...
export const post: BlogPost = {
  ...
  description:
    'Aucune loi fédérale unique n’impose la RC professionnelle à tout artisan : plusieurs cantons et donneurs d’ordre l’exigent pourtant de fait pour certains métiers. Le point clair.',
  excerpt:
    'Il n’existe pas de loi fédérale unique imposant la RC pro à tout artisan. Ce qui l’impose en pratique, c’est souvent le canton ou le donneur d’ordre, et parfois un sinistre qu’on découvre trop tard n’être pas couvert.',
  ...
  blocks: [
    ...
    {
      type: 'p',
      text: 'Le réflexe le plus utile n’est pas de se demander « suis-je obligé ? » mais « qu’est-ce que je risque réellement si ce n’est pas couvert ? ». Sur un métier à risque physique (échafaudage, toiture, terrassement), la réponse penche presque toujours vers une souscription, qu’elle soit obligatoire ou non sur le papier.',
    },
    {
      type: 'cta',
  ...
  faq: [
    {
      ...
      answer:
        'Non, il n’existe pas de loi fédérale unique l’imposant à tous les métiers du bâtiment. En revanche, plusieurs cantons l’exigent pour certains métiers réglementés, et de nombreux donneurs d’ordre la demandent systématiquement.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Faute d’assurance intermédiaire pour absorber le coût, le patrimoine de l’entreprise, voire personnel pour une entreprise individuelle, peut être directement engagé pour couvrir les dommages.',
    },
  ],
  relatedSlugs: [
