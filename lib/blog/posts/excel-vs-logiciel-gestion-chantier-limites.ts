...
export const post: BlogPost = {
  ...
  description:
    'Excel fonctionne bien à petite échelle, jusqu’au jour où un deuxième employé le modifie en même temps, ou où un devis oublié finit par coûter plus cher que l’outil censé le remplacer.',
  excerpt:
    'Beaucoup d’entreprises du bâtiment démarrent avec un fichier Excel bricolé au fil des années. Ce n’est pas un mauvais choix au départ, mais c’est un choix qui vieillit mal, souvent sans qu’on s’en rende compte.',
  ...
  blocks: [
    {
      type: 'p',
      text: 'Excel reste un outil redoutablement efficace pour ce qu’il fait bien : calculer, trier, ajuster une formule en quelques secondes. Le problème n’est jamais Excel en tant que tel. C’est plutôt le moment où un fichier de suivi de chantier, pensé à l’origine pour un usage simple, se retrouve à porter des responsabilités pour lesquelles il n’a pas été conçu.',
    },
    ...
    { type: 'h2', text: 'Là où ça casse à l’échelle' },
    {
      type: 'list',
      items: [
        'Deux personnes qui modifient le même fichier en parallèle, avec le risque réel d’écraser le travail de l’autre sans le moindre avertissement',
        'Aucune trace fiable de qui a changé quoi, ni quand, ce qui rend un litige avec un client difficile à documenter précisément',
        ...
        'Aucun lien automatique entre un devis, la facture qui en découle et le paiement réellement reçu, si bien que tout le rapprochement se fait à la main',
      ],
    },
    {
      type: 'callout',
      title: 'Le vrai coût d’Excel n’est pas dans le fichier, il est dans les erreurs qu’il ne montre pas',
      text: 'Un tableau de suivi qui « a l’air à jour » peut très bien cacher un devis jamais facturé ou une facture jamais relancée : Excel ne signale jamais activement ce qui a été oublié, contrairement à un outil pensé pour ça.',
    },
    {
      type: 'cta',
  ...
  faq: [
    {
      ...
      answer:
        'Pour un usage ponctuel (métré, budget isolé), oui. Mais dès que plusieurs personnes travaillent sur le même suivi ou que le volume de devis et factures augmente, les limites deviennent vite problématiques.',
    },
    {
      question: 'Quel est le principal risque d’Excel pour la gestion de chantier ?',
      answer:
        'L’absence de trace fiable des modifications, combinée à l’absence de lien automatique entre devis, facture et paiement. Résultat : les oublis ne sont jamais signalés activement par le fichier.',
    },
    {
