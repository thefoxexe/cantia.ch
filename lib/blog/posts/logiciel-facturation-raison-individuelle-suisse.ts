...
export const post: BlogPost = {
  ...
  description:
    'Une raison individuelle n\'a pas les mêmes obligations qu\'une société de capitaux, mais un logiciel de facturation reste tout aussi utile — pour d\'autres raisons.',
  excerpt:
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Non, les mentions légales de base (numérotation, TVA le cas échéant) s\'appliquent quel que soit le statut — raison individuelle, Sàrl ou SA.',
    },
    {
