...
export const post: BlogPost = {
  ...
  blocks: [
    {
      type: 'p',
      text: 'Une facture en retard de dix jours n’est presque jamais un signal d’impayé. C’est plutôt le signe qu’elle est tombée dans une pile de courrier, un email noyé, ou un virement mis en attente puis oublié. Traiter chaque retard comme une confrontation dès le premier jour abîme des relations qui n’avaient rien de conflictuel.',
    },
    { type: 'h2', text: 'Trois temps, pas un seul ton' },
    {
      ...
      ordered: true,
      items: [
        'Rappel neutre, dès le lendemain de l’échéance : « Petit rappel, la facture n°XXX arrive à échéance, avez-vous pu la traiter ? », sans aucune accusation, juste un signal',
    ...
    },
    {
      ...
      text: 'Rien n’abîme plus une relation qu’une relance envoyée à un client qui a payé trois jours plus tôt. C’est le meilleur moyen de transformer un simple oubli en vraie tension, et pourtant c’est évitable dès lors que chaque paiement reçu se rapproche automatiquement à sa facture via la référence QR, sans dépendre d’une vérification manuelle du relevé bancaire.',
    },
