  ...
  blocks: [
    ...
    { type: 'h2', text: 'Ce qui fonctionne concrètement' },
    {
      ...
      items: [
        ...
        'Une vue par personne et par machine, pas seulement par chantier — pour repérer un conflit avant qu’il ne devienne un problème sur le terrain',
