...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    { type: 'h2', text: 'Pourquoi le début est justement le moment critique' },
    {
      ...
      items: [
        ...
        'Les premiers clients sont souvent les plus fidèles s\'ils sont bien traités dès le départ — un document approximatif entame cette confiance',
    ...
    {
      type: 'p',
      text: 'Un abonnement à CHF 30-40 par mois représente une fraction infime du chiffre d\'affaires d\'un premier chantier — largement compensé si l\'outil permet d\'envoyer un devis professionnel plus vite qu\'un concurrent, ou de garder un client grâce à une facturation impeccable.',
    },
    {
      type: 'callout',
      title: 'S\'équiper tôt, ce n\'est pas se compliquer la vie — c\'est l\'inverse',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Au début — avec peu de clients à gérer, il y a le temps de bien apprendre l\'outil, contrairement à une adoption en urgence une fois submergé par le volume de documents.',
    },
    {
