...
export const post: BlogPost = {
  ...
  excerpt:
    'Aucun autre métier du bâtiment n’est aussi directement exposé à la météo que la couverture — un devis de toiture qui ne prévoit ni marge météo ni coût de sécurité prend un pari qu’il finit souvent par perdre.',
  ...
  blocks: [
    {
      type: 'p',
      text: 'Un chantier de toiture ne peut pas avancer sous la pluie, ni parfois sous un vent trop fort. Un devis qui ne provisionne pas ce risque météo transforme chaque intempérie en perte sèche pour l’entreprise — le client, lui, ne paie que le travail réellement effectué.',
    },
    ...
    },
    {
      ...
      text: 'Prévoir explicitement au devis qu’un arrêt météo décale le planning sans pénalité évite une négociation tendue en plein chantier — le client comprend mieux un report annoncé à l’avance qu’un retard découvert sur place.',
    },
    {
      type: 'cta',
      title: 'Suivez l’avancement du chantier depuis le téléphone, même en hauteur',
      text: 'Cantia permet d’ajouter photos et rapports d’avancement directement depuis le chantier — utile pour documenter un arrêt météo ou un imprévu de charpente découvert en cours de dépose.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Non, ou seulement de manière très approximative — l’état réel d’une charpente n’est souvent visible qu’après dépose de la couverture existante, d’où l’intérêt d’une inspection avant devis définitif.',
    },
  ],
  relatedSlugs: [
