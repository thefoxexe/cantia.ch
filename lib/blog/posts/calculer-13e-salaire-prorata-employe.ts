...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    {
      type: 'p',
      text: 'Le 13e salaire au prorata dû lors d’un départ en cours d’année est régulièrement oublié dans le décompte final, surtout quand le départ est géré dans l’urgence. C’est une créance de l’employé, pas un geste facultatif. L’omettre expose donc à une réclamation, souvent bien après le départ effectif.',
    },
    {
      type: 'cta',
      title: 'Les salaires de l’équipe, calculés proprement',
      text: 'Le module RH & Salaires de Cantia calcule le salaire net à partir des heures et des taux configurés par employé, ce qui en fait une base plus fiable qu’un calcul refait à la main à chaque départ.',
