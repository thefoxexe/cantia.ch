...
export const post: BlogPost = {
  ...
  blocks: [
    {
      type: 'p',
      text: 'Recourir à un travailleur temporaire pour absorber un pic d’activité est courant dans le bâtiment — mais l’opération passe légalement par une entreprise de location de services, soumise à autorisation cantonale et fédérale, et non par un simple accord informel entre deux entreprises.',
    },
    ...
    {
      type: 'p',
      text: 'Un intérimaire placé sur un chantier de construction reste soumis aux conditions de la convention collective de travail applicable au secteur, au même titre qu’un employé fixe — l’agence de location doit en tenir compte dans le salaire versé, ce qui explique en partie le coût horaire plus élevé facturé à l’entreprise utilisatrice.',
    },
    {
      type: 'callout',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Le tarif facturé inclut déjà le salaire, les charges sociales et la marge de l’agence — la comparaison pertinente est avec le coût horaire complet d’un employé, pas son seul salaire brut.',
    },
  ],
  relatedSlugs: [
