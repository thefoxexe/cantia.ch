...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    { type: 'h2', text: 'Pourquoi ça casse, dans les faits' },
    {
      type: 'list',
      items: [
        'Une formule modifiée par erreur sur une ligne se propage silencieusement, sans que personne ne le remarque avant que le total final soit visiblement faux',
