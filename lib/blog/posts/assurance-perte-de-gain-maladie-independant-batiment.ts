...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      ...
      text: 'Voir précisément ce que rapporte chaque chantier aide aussi à budgétiser sereinement une prévoyance volontaire, et le module Rentabilité de Cantia donne justement cette visibilité en continu.',
