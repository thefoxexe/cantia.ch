...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      ...
      text: 'Sans 2e pilier, un indépendant ne compte que sur l’AVS et son épargne privée pour la retraite. Les cotisations LPP volontaires sont aussi déductibles fiscalement — un outil de prévoyance et d’optimisation fiscale en même temps, à évaluer avec un professionnel selon la situation exacte.',
    },
    { type: 'h2', text: 'L’exception qui piège tout le monde : la LAA/SUVA' },
    {
      type: 'p',
      text: 'Ce qui complique la donne, ce n’est pas la LPP directement, c’est la LAA (assurance-accidents). Pour les salariés, elle est obligatoire — et gérée par la SUVA dans de nombreux métiers du bâtiment considérés à risque : gros œuvre, couverture, échafaudage, génie civil. Pour un indépendant sans employé, la LAA reste en principe facultative, sauf dans certains métiers où la SUVA impose une affiliation même à l’indépendant lui-même, sur la base d’une liste réglementaire que peu de gens consultent avant de signer leur premier chantier.',
    },
    {
      type: 'list',
      items: [
