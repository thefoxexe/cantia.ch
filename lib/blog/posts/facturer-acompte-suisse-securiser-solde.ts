...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      ...
      text: 'À aucun moment du chantier l’entreprise ne devrait avoir avancé plus que ce qui a déjà été facturé et encaissé. Si un poste matériel important arrive avant la prochaine échéance de paiement, c’est l’échéancier qui est mal découpé, pas le client qui agit de mauvaise foi.',
    },
    { type: 'h2', text: 'Ce qui rend un acompte vraiment exécutoire' },
    {
      type: 'p',
      text: 'L’échéancier de paiement doit figurer sur le devis signé, pas être négocié à l’oral une fois le chantier lancé. Un accord verbal du type « je vous paierai au fur et à mesure » ne protège rien juridiquement et se transforme régulièrement en malentendu de bonne foi des deux côtés.',
    },
    {
      type: 'cta',
      title: 'Des factures d’acompte qui se déduisent automatiquement',
      text: 'Cantia permet de facturer un pourcentage du devis en acompte, puis déduit ce montant de la facture finale sans ressaisie, et l’échéancier reste visible du premier au dernier paiement.',
