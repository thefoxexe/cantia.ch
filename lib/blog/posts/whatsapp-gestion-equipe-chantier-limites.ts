...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    { type: 'h2', text: 'Où ça craque concrètement' },
    {
      type: 'list',
      items: [
        'Une information importante envoyée un mardi se noie sous cinquante messages avant le jeudi — personne ne la retrouve sans faire défiler tout l’historique',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Pas nécessairement — WhatsApp reste efficace pour l’urgence ponctuelle. La transition la plus efficace déplace surtout ce qui doit rester retrouvable (planning, photos, historique) vers un outil structuré par chantier.',
    },
  ],
  relatedSlugs: [
