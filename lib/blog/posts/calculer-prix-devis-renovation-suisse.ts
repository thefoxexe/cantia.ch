...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    {
      type: 'p',
      text: 'En rénovation, l’imprévu n’est pas l’exception, c’est la norme : mur porteur découvert derrière un doublage, installation électrique hors normes, humidité qui remonte d’un vide sanitaire personne n’avait ouvert depuis vingt ans. Un devis qui ne provisionne rien pour ça se transforme systématiquement en avenant pénible à négocier une fois le chantier ouvert, précisément au moment où le rapport de force a basculé du côté du client.',
    },
    { type: 'h2', text: '4. La TVA, sur le bon montant' },
    {
      type: 'p',
      text: 'Le taux normal suisse est 8,1 % depuis le 1er janvier 2024, appliqué sur le total HT (main-d’œuvre + matériel + marge), et non ligne par ligne avec des arrondis qui dérivent sur une longue liste de positions. C’est exactement le genre d’erreur invisible que produit un tableur mal conçu.',
    },
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Les deux approches existent : soit une provision intégrée au prix ferme, soit une clause explicite prévoyant une facturation complémentaire sur devis supplémentaire en cas de découverte imprévue, à condition toutefois que cette clause figure clairement sur le devis initial.',
    },
    {
