...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      ...
      text: 'Une facture sans échéance écrite est en théorie payable immédiatement, mais en pratique presque impossible à faire respecter, faute de date de référence claire pour calculer un retard. Une échéance précise n’est pas une formalité — c’est ce qui rend un retard exigible.',
    },
    { type: 'h2', text: 'Ce qui se passe une fois l’échéance dépassée' },
    {
      type: 'list',
      items: [
        'Le débiteur est en demeure automatiquement dès que l’échéance convenue est dépassée (art. 102 al. 2 CO) — pas besoin de rappel formel si une date était indiquée',
        ...
        'Sans échéance écrite, il faut d’abord une sommation pour faire courir ce délai — d’où l’intérêt de toujours dater précisément',
      ],
    },
    { type: 'h2', text: 'Ce qu’il faut vraiment écrire sur une facture' },
    {
      ...
      items: [
        ...
        'Un numéro de référence QR pour identifier immédiatement un paiement reçu — et ne jamais relancer par erreur un client qui a déjà payé',
      ],
    },
    {
      type: 'p',
