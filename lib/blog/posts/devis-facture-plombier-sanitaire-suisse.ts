...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      ...
      text: 'Avec Cantia, une intervention de dépannage devient une facture en quelques minutes depuis le téléphone — pas besoin de revenir au bureau pour ne pas laisser traîner une urgence facturée trois semaines plus tard.',
