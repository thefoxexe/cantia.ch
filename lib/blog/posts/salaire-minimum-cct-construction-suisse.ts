...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    {
      type: 'p',
      text: 'Le salaire minimum varie selon la qualification (ouvrier non qualifié, qualifié, contremaître) et selon la région salariale — les cantons ou zones ne sont pas tous alignés sur le même barème. Un ouvrier qualifié à Genève et le même profil dans une zone rurale d’un autre canton ne partent pas du même minimum garanti.',
    },
    {
      type: 'callout',
    ...
    { type: 'h2', text: 'Où vérifier le bon chiffre' },
    {
      ...
      items: [
        ...
        'Les barèmes se mettent à jour chaque année — un chiffre appris il y a deux ans n’est jamais une valeur sûre',
