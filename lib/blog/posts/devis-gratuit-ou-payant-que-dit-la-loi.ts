...
export const post: BlogPost = {
  ...
  description:
    'Aucune loi suisse n’oblige un artisan à établir un devis gratuit. C’est simplement la pratique du marché qui en a fait la norme. Voici quand facturer un devis est justifié, et comment le poser sans perdre le client.',
  excerpt:
    'Un devis représente des heures de calcul, parfois même un déplacement. Pourtant, presque personne ne le facture. Ce n’est pas une obligation légale, c’est un usage. La nuance change tout pour un chiffrage complexe.',
  ...
  blocks: [
    ...
    },
    {
      ...
      text: 'Une pratique courante et bien acceptée : facturer un montant symbolique pour l’étude, déductible du prix total si le chantier est finalement confié, car cela sécurise le temps investi sans braquer un client sérieux.',
    },
