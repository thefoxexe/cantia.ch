...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    {
      type: 'p',
      text: 'Un défaut visible au moment de la réception doit être signalé sur-le-champ — s’il ne l’est pas, le client est réputé l’avoir accepté tel quel, sauf clause contraire. Un défaut caché, non détectable lors d’une vérification normale, reste couvert par le délai de garantie même après une réception sans réserve.',
    },
    {
      type: 'callout',
      title: 'La condition qui fait basculer la responsabilité',
      text: 'Depuis la réforme du droit de la garantie entrée en vigueur en 2026, un défaut caché doit être signalé dans les 60 jours suivant sa découverte. Un client qui attend six mois après avoir remarqué le problème risque de perdre son droit à réparation — même si le défaut lui-même reste dans le délai de garantie de 5 ans.',
    },
    { type: 'h2', text: 'Ce qui détermine qui paie' },
    {
      ...
      items: [
        ...
        'Le défaut résulte-t-il d’un vice d’exécution de l’entrepreneur, ou d’un mauvais usage postérieur par le client — la charge de la preuve joue un rôle décisif ici',
      ],
    },
    ...
    },
    {
      ...
      text: 'Les rapports Cantia horodatent et géolocalisent chaque photo prise sur le chantier — la trace la plus solide en cas de litige de garantie, sans effort de classement supplémentaire.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Il est en principe réputé accepté par le client, sauf clause contraire prévue au contrat — d’où l’intérêt d’un procès-verbal de réception détaillé listant précisément ce qui a été vérifié.',
    },
    {
