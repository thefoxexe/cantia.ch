...
export const post: BlogPost = {
  ...
  description:
    'Bien que des actes interruptifs existent, une créance contractuelle se prescrit en principe par 10 ans en Suisse, et les ignorer peut faire perdre définitivement le droit de réclamer un paiement.',
  excerpt:
    'Dix ans paraît long, du moins jusqu’à ce qu’une vieille facture oubliée dans un dossier se révèle totalement irrécupérable au moment où l’entreprise en a le plus besoin.',
  ...
  blocks: [
    ...
    {
      type: 'p',
      text: 'Dix ans semble une échéance lointaine. Pourtant, une créance ancienne, oubliée dans les archives d’une petite entreprise, peut se révéler totalement irrécupérable au moment où elle serait utile. Un suivi centralisé de chaque facture, avec sa date d’émission et son statut de paiement, est le seul moyen fiable de repérer une créance qui approche de sa prescription avant qu’il ne soit trop tard pour agir.',
    },
    {
      type: 'cta',
