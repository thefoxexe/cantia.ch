...
export const post: BlogPost = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'En l’indiquant explicitement et par écrit dès le devis, surtout en haute saison où les délais peuvent dépasser deux à trois mois — cela évite tout malentendu une fois le devis signé.',
    },
    {
