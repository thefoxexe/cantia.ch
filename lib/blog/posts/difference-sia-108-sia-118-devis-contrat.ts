...
export const post: BlogPost = {
  ...
  excerpt:
    'Les deux normes portent des numéros voisins et sortent du même éditeur — mais l’une concerne les travaux de construction, l’autre les prestations intellectuelles. La confusion est fréquente et coûteuse.',
  ...
  blocks: [
    ...
    {
      type: 'p',
      text: 'La SIA 118 s’applique à un contrat d’entreprise (art. 363 CO et suivants) — l’entrepreneur doit un résultat (l’ouvrage terminé). La SIA 108 s’applique à un contrat de mandat (art. 394 CO et suivants) — le mandataire doit des moyens et une diligence, pas un résultat garanti. Cette distinction change fondamentalement le régime de responsabilité applicable.',
    },
    ...
    },
    {
      ...
      text: 'La SIA 108 concerne les métiers de conception et de direction de projet — un entrepreneur qui exécute des travaux relève du régime du contrat d’entreprise, donc de la SIA 118 si elle est appliquée.',
    },
    {
      type: 'cta',
  ...
  faq: [
    {
      ...
      answer:
        'La SIA 118, qui régit le contrat d’entreprise entre maître d’ouvrage et entrepreneur — la SIA 108 concerne les mandataires comme les architectes et ingénieurs.',
    },
    {
