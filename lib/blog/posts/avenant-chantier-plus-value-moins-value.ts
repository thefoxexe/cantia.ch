...
export const post: BlogPost = {
  ...
  blocks: [
    {
      type: 'p',
      text: '« Tant que vous êtes là, vous pourriez aussi… ». C’est la phrase qui démarre la moitié des avenants de chantier, presque toujours à l’oral, presque toujours sans qu’un nouveau prix soit clairement acté avant que le travail commence.',
    },
    ...
    },
    {
      ...
      text: 'Cantia permet de créer rapidement un avenant lié au devis initial, avec le nouveau total recalculé automatiquement, puis envoyé au client avant que le travail supplémentaire ne démarre.',
  ...
  faq: [
    {
      ...
      answer:
        'Oui, systématiquement, y compris pour un petit montant : cela maintient une référence claire et évite que le client ne s’habitue à des ajustements gratuits.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Oui : la déduction et le nouveau total doivent être clairement actés, pour éviter toute contestation ultérieure sur le montant final.',
    },
  ],
  relatedSlugs: [
