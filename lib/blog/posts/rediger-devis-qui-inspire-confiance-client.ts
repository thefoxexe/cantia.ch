  ...
  blocks: [
    ...
    { type: 'h2', text: '2. Dire clairement ce qui n’est pas inclus' },
    {
      ...
      items: [
        ...
        'La validité du devis dans le temps (30 jours, par exemple), car un prix matériel peut bouger d’une semaine à l’autre',
    ...
    {
      type: 'p',
      text: 'Un devis propre, avec logo, coordonnées complètes, mise en page cohérente, sans police mélangée ni tableau mal aligné, projette un sérieux qui rassure avant même la lecture du contenu. C’est injuste sur le fond : la qualité du travail à venir n’a rien à voir avec la mise en page d’un document. Mais c’est un biais bien documenté dans la décision d’achat, et il joue contre vous si personne n’y prête attention.',
    },
    { type: 'h2', text: '4. Retirer la friction de la signature' },
    {
      type: 'p',
      text: 'Un devis envoyé en pièce jointe PDF qu’il faut imprimer, signer, scanner ajoute une étape logistique qui fait repousser la décision. Ce n’est pas un manque d’intérêt, juste de la flemme. Un lien vers un portail où le client lit, pose une question et signe directement en ligne réduit ce frein sans rien retirer au sérieux du document.',
    },
