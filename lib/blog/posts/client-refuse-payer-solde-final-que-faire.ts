...
export const post: BlogPost = {
  ...
  blocks: [
    {
      type: 'p',
      text: 'Le chantier est fini, la facture finale envoyée, et pourtant le client ne paie pas. Avant toute démarche de recouvrement, une question précède toutes les autres : pourquoi ? Un refus de paiement n’a presque jamais une seule cause, et la stratégie à suivre change complètement selon la réponse.',
    },
    ...
    },
    {
      ...
      text: 'Si le client invoque un défaut, une retenue de garantie proportionnée à ce défaut précis (pas au solde entier) est une réaction plus solide juridiquement qu’un refus de paiement total. C’est aussi ce qu’un juge attendra de voir documenté si le litige s’envenime. À l’inverse, retenir 100 % du solde pour un défaut mineur affaiblit la position du client, pas la vôtre.',
    },
    { type: 'h2', text: 'La marche à suivre concrète' },
    {
      ...
      items: [
        ...
        'Documenter chaque échange par écrit à partir de ce moment, car c’est ce qui constituera la base d’un dossier si le litige va plus loin',
