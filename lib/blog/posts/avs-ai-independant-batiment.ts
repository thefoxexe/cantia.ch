...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      ...
      text: 'Sous CHF 60’500 de revenu annuel, le taux de cotisation AVS/AI/APG est dégressif, donc nettement moins lourd que le taux plein d’environ 10 % appliqué au-delà. Beaucoup d’indépendants en phase de démarrage paient un taux qu’ils croient fixe alors qu’il change chaque année avec leur revenu.',
    },
    ...
    { type: 'h2', text: 'AVS/AI n’est pas la LPP : ce qui complique tout' },
    {
      type: 'p',
    ...
    },
    {
      ...
      text: 'Le module Rentabilité de Cantia suit ce que chaque chantier rapporte réellement une fois les coûts déduits, ce qui en fait une base bien plus fiable pour estimer vos acomptes AVS qu’un chiffre approximatif tapé de mémoire.',
