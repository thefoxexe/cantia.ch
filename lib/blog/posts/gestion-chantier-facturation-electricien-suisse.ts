...
export const post: BlogPost = {
  ...
  excerpt:
    'Un électricien change souvent de chantier trois ou quatre fois par jour — la vraie difficulté n’est pas de chiffrer un point électrique, c’est de retrouver le soir qui a fait quoi, où, et combien de temps.',
  ...
  blocks: [
    ...
    },
    {
      ...
      text: 'Une installation électrique modifiée ou créée doit être annoncée et contrôlée conformément à l’inspection des installations électriques (NIBT). L’oublier sur le devis, c’est risquer de le facturer en urgence — moins bien, et souvent moins cher que ce que ça coûte réellement en temps.',
    },
    {
      type: 'cta',
      title: 'Vos heures, saisies chantier par chantier, en quelques secondes',
      text: 'Cantia permet de pointer ses heures directement depuis le téléphone entre deux interventions, chantier par chantier — de quoi retrouver en fin de mois exactement qui a fait quoi, sans reconstituer la journée de mémoire.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Oui — toute installation créée ou modifiée doit être annoncée et contrôlée. L’intégrer au devis dès le départ évite une facturation d’urgence, moins avantageuse, une fois le chantier terminé.',
    },
  ],
  relatedSlugs: [
