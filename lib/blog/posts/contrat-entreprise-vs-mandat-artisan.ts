  ...
  faq: [
    {
      ...
      answer:
        'Presque toujours sous contrat d’entreprise (art. 363 et suivants CO), qui engage sur un résultat — contrairement à un architecte en phase de conseil, souvent sous mandat.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Oui, fréquemment : un architecte sous mandat pour la conception et le suivi, des entreprises sous contrat d’entreprise pour l’exécution — chaque acteur relevant du régime adapté à sa mission.',
    },
  ],
  relatedSlugs: [
