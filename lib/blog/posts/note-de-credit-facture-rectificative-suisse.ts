...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    { type: 'h2', text: 'Pourquoi ne jamais réémettre le même numéro de facture' },
    {
      type: 'list',
      items: [
        'La numérotation des factures doit rester continue et chronologique — réutiliser ou modifier un numéro déjà émis casse cette continuité, un point vérifié en cas de contrôle fiscal',
        'Le client a peut-être déjà enregistré la facture initiale dans sa propre comptabilité — un doublon silencieux crée une confusion difficile à tracer plus tard',
