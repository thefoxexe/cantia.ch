...
export const post: BlogPost = {
  ...
  blocks: [
    {
      type: 'p',
      text: 'Un client dit oui au téléphone, le chantier démarre la semaine suivante sans qu’aucun papier n’ait été signé. Beaucoup d’artisans pensent qu’un tel accord ne « compte pas vraiment » tant qu’il n’est pas sur papier. C’est faux — et ça change radicalement la façon de gérer un litige quand ça arrive.',
    },
    ...
    { type: 'h2', text: 'Ce qui se joue concrètement en cas de litige' },
    {
      type: 'list',
      items: [
        'Sans trace écrite, le prix convenu devient une question de mémoire de chacun — et les deux souvenirs divergent rarement en faveur du même montant',
        'Le périmètre exact des travaux (« ça inclut la peinture ou pas ? ») se discute après coup, au pire moment possible',
        'Un juge civil suisse statue sur la base des preuves apportées, pas sur la parole donnée — un accord oral non documenté part avec un désavantage structurel',
      ],
    },
    ...
    },
    {
      ...
      text: 'Avec la dictée vocale de Cantia, un accord donné au téléphone se transforme en devis PDF chiffré en quelques minutes — la trace écrite existe sans ralentir le rythme du chantier.',
  ...
  faq: [
    {
      ...
      answer:
        'Oui — l’art. 11 CO n’exige aucune forme particulière par défaut pour un contrat d’entreprise. Un accord verbal engage juridiquement les deux parties.',
    },
    {
