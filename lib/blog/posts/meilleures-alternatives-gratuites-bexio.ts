...
export const post: BlogPost = {
  slug: 'meilleures-alternatives-gratuites-bexio',
  question: 'Existe-t-il des alternatives gratuites ou plus abordables à Bexio pour démarrer ?',
  title: 'Alternatives à Bexio pour démarrer, sans le prix d\'un outil comptable complet',
  description:
  ...
  blocks: [
    ...
    },
    {
      type: 'stat',
      value: '2',
      label: 'profils d\'usage différents à distinguer : la comptabilité complète d\'une entreprise établie, et le pilotage quotidien (devis, chantier, facture) d\'une entreprise qui démarre',
    },
    ...
    {
      type: 'callout',
      title: 'Le bon choix dépend du stade de l\'entreprise',
      text: 'Une entreprise qui démarre gagne souvent à commencer par un outil léger et spécialisé bâtiment, puis à connecter un outil comptable complet une fois le volume d\'activité le justifiant.',
    },
    {
      type: 'cta',
  ...
  faq: [
    {
      question: 'Bexio est-il adapté à une entreprise du bâtiment qui démarre ?',
      answer:
        'Il couvre très bien la comptabilité complète, mais une entreprise qui démarre a souvent d\'abord besoin d\'un outil spécialisé bâtiment (devis, chantier, photos) plus léger et plus abordable.',
    },
    {
