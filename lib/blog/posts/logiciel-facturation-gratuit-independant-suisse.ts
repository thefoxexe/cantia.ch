...
export const post: BlogPost = {
  ...
  question: 'Existe-t-il un logiciel de facturation vraiment gratuit pour un indépendant en Suisse ?',
  title: 'Logiciel de facturation gratuit pour indépendant : ce qu\'on obtient vraiment',
  description:
  ...
  blocks: [
    ...
    {
      type: 'p',
      text: 'La conformité TVA suisse et la QR-facture ne sont pas des options de confort : un document mal formaté peut être refusé par la banque du client ou compliqué à traiter côté comptabilité. Avant de choisir un plan gratuit, vérifier qu\'il inclut bien ces deux points évite une migration forcée dans les premières semaines d\'activité.',
    },
    {
      type: 'callout',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Un plafond de documents émis par mois (souvent 5 à 10), au-delà duquel il faut passer à un plan payant pour continuer à facturer.',
    },
    {
      question: 'Vaut-il mieux un outil gratuit limité ou un essai gratuit complet ?',
      answer:
        'Un essai gratuit complet donne une idée plus fiable de ce que l\'outil vaut réellement pour l\'activité, plutôt qu\'une version tronquée qui ne montre jamais tout ce qui sera nécessaire une fois l\'activité lancée.',
    },
  ],
  relatedSlugs: [
