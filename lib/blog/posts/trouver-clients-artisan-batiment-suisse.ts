...
export const post: BlogPost = {
  ...
  excerpt:
    'La majorité des artisans du bâtiment en Suisse trouvent leurs clients sans jamais avoir dépensé un centime en publicité — mais ce n’est pas un hasard, c’est le résultat de quelques habitudes précises, répétées dans la durée.',
  ...
  blocks: [
    ...
    { type: 'h2', text: 'Les canaux qui rapportent le plus, dans l’ordre' },
    {
      type: 'list',
      items: [
        'Le bouche-à-oreille d’un client satisfait — de loin le plus fiable, mais qu’il faut activement encourager (voir un article dédié sur le parrainage)',
        ...
        'Le réseau professionnel (autres corps de métier, architectes, régies) — un maçon recommandé par un architecte vaut plusieurs prospects froids',
