...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    { type: 'h2', text: 'Les critères spécifiques au bâtiment suisse' },
    {
      type: 'list',
      items: [
        'QR-facture native et conforme (IBAN/QR-IBAN, adresse structurée depuis la norme 2.3), et non pas un module tiers ajouté après coup',
        ...
        'Une application qui fonctionne sur le terrain, y compris sans réseau, et pas seulement un outil de bureau',
  ...
  faq: [
    {
      ...
      answer:
        'Rarement, car la plupart n’ont pas de QR-facture native conforme, ni de lien entre devis/facture et chantier, ce qui oblige à ressaisir l’information à la main.',
    },
    {
