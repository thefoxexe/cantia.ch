...
export const post: BlogPost = {
  ...
  blocks: [
    {
      type: 'p',
      text: 'Dans le langage courant du bâtiment, « devis » et « offre » s’emploient souvent comme des synonymes — et dans la plupart des cas, ça ne pose pas de problème. La confusion devient gênante quand une « facture pro forma » entre dans la conversation, parce que ce document-là ne joue pas du tout le même rôle.',
    },
    ...
    },
    {
      ...
      text: 'Une facture pro forma est un document informatif qui présente un montant estimé — souvent utilisé pour des démarches administratives (dossier de financement, douane) — mais elle ne constitue ni une créance juridique, ni une acceptation contractuelle. Contrairement à un devis accepté, elle n’engage aucune des deux parties.',
    },
    ...
    {
      type: 'p',
      text: 'Le risque concret d’une confusion : envoyer une « facture pro forma » en pensant avoir sécurisé un engagement client, alors qu’aucune acceptation contractuelle n’a réellement eu lieu — le client peut se rétracter sans aucune conséquence juridique, contrairement à un devis dûment accepté.',
    },
    {
      type: 'cta',
