...
export const post: BlogPost = {
  ...
  excerpt:
    'Beaucoup d’artisans citent « 2 ans » de garantie par réflexe. Pour tout ce qui est fixé au bâtiment, la loi suisse dit 5 ans — et un nouveau délai de 60 jours vient de changer la donne en 2026.',
  ...
  blocks: [
    {
      type: 'p',
      text: '« Deux ans de garantie » est le chiffre que tout le monde répète dans le bâtiment — et c’est faux pour l’essentiel de ce qui touche à un ouvrage fixé au sol. L’art. 371 al. 2 du Code des obligations fixe le délai à cinq ans pour un ouvrage immobilier, pas deux.',
    },
