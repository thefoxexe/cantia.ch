...
export const post: BlogPost = {
  slug: 'faire-evoluer-outil-gestion-avec-entreprise',
  question: 'Comment faire évoluer son outil de gestion au même rythme que son entreprise ?',
  title: 'Faire évoluer son outil de gestion en même temps que l\'entreprise, pas après coup',
  description:
  ...
  blocks: [
    ...
    { type: 'h2', text: 'Les signaux qui annoncent un besoin d\'évolution' },
    {
      type: 'list',
      items: [
        'Un tableur "de secours" apparaît à côté de l\'outil principal pour combler un manque',
        'Une tâche revient chaque semaine sans que l\'outil ne l\'automatise',
        'Un nouveau type de chantier ou de prestation ne rentre plus bien dans les catégories existantes',
        'Une nouvelle personne rejoint l\'équipe et l\'outil actuel ne prévoit pas vraiment sa place',
      ],
    },
    {
      type: 'stat',
      value: '1 fois/an',
      label: 'fréquence raisonnable pour faire le point sur ses outils de gestion et vérifier s\'ils couvrent encore correctement les besoins réels de l\'entreprise',
    },
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Une fois par an est une bonne pratique courante, pour vérifier si l\'outil couvre encore correctement les besoins réels de l\'entreprise à ce stade de son développement.',
    },
  ],
  relatedSlugs: [
