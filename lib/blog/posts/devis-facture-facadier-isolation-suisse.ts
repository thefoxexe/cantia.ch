...
export const post: BlogPost = {
  ...
  excerpt:
    'L’isolation périphérique est l’un des rares chantiers du bâtiment où le prix du devis influence directement un dossier administratif parallèle, celui de la subvention cantonale, et cette dépendance change la façon de facturer.',
  ...
  blocks: [
    ...
    },
    {
      ...
      text: 'Un dossier de subvention peut prendre plusieurs semaines à être validé. Prévoir une durée de validité de devis suffisamment longue, ou à défaut une clause de révision claire en cas de dépassement, évite de devoir refaire un devis identique juste pour une question de délai administratif.',
    },
    {
      type: 'cta',
  ...
  faq: [
    {
      ...
      answer:
        'C’est fortement recommandé, car les dossiers de subvention cantonaux (Programme Bâtiments) exigent généralement une valeur d’isolation précise, pas seulement une désignation commerciale du matériau.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'C’est conseillé, car le montage d’un dossier de subvention peut prendre plusieurs semaines ; une clause de révision claire évite alors de devoir refaire un devis identique pour un simple dépassement de délai.',
    },
  ],
  relatedSlugs: [
