...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    },
    {
      ...
      text: 'Cantia permet de générer un devis rapide et chiffré même pour une petite intervention — la trace existe sans ralentir le rythme d’une journée chargée.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Dans la plupart des cas pratiques, oui — un message confirmant la date, la prestation et le montant transforme un accord oral fragile en preuve exploitable.',
    },
  ],
  relatedSlugs: [
