...
export const post: BlogPost = {
  ...
  blocks: [
    {
      type: 'p',
      text: 'Une cuisine ou une bibliothèque sur mesure ne se chiffre pas comme la pose d’un élément standard. Le temps de conception (prise de cotes, plans, choix des matériaux avec le client) est souvent aussi long que la fabrication elle-même — et il est presque toujours le plus mal valorisé, car difficile à montrer concrètement au client au moment de présenter le prix.',
    },
  ...
  faq: [
    {
      ...
      answer:
        'C’est recommandé, au moins comme un forfait d’étude déductible du prix final si le devis est signé — cela protège un temps de travail réel qui reste souvent invisible pour le client.',
    },
    {
