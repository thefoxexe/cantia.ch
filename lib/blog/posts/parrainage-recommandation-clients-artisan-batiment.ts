  ...
  blocks: [
    ...
    { type: 'h2', text: 'Le bon moment et la bonne façon de le demander' },
    {
      ...
      items: [
        ...
        'Sans mettre de pression, car une phrase suffit, pas besoin d’un argumentaire',
    ...
    },
    {
      ...
      text: 'Un chantier propre, une équipe ponctuelle et respectueuse des lieux du client jouent un rôle presque aussi important que la qualité technique du travail dans la décision de recommander. En pratique, la propreté du chantier reste ce qui se voit et se raconte le plus facilement.',
    },
    {
      type: 'cta',
  ...
  faq: [
    {
      ...
      answer:
        'Le meilleur moment est juste après la réception des travaux, quand la satisfaction est la plus fraîche et concrète, et une demande simple, sans pression, suffit généralement.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Parce que la confiance est déjà en partie établie par le lien avec la personne qui recommande. Le prospect arrive ainsi avec un a priori positif que ne peut pas offrir une prise de contact sans lien préalable.',
    },
  ],
  relatedSlugs: [
