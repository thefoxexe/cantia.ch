...
export const post: BlogPost = {
  ...
  blocks: [
    ...
    {
      type: 'p',
      text: 'La loi fédérale du 17 juin 2005 concernant des mesures en matière de lutte contre le travail au noir (LTN), avec son ordonnance d’application (OTN), vise à s’assurer que les obligations d’annonce et d’autorisation liées au droit des assurances sociales, au droit des étrangers et à l’impôt à la source sont correctement respectées — pas seulement l’absence totale de déclaration, mais aussi des déclarations partielles ou incomplètes.',
    },
    {
      type: 'callout',
    ...
    {
      type: 'p',
      text: 'Pour l’entreprise elle-même, la meilleure protection reste la plus simple : une affiliation à jour de chaque collaborateur, des contrats de travail en bonne et due forme, et une trace claire des heures effectivement travaillées — le genre de documentation qu’un contrôle demande en premier lieu.',
    },
    {
      type: 'cta',
      title: 'Les heures de l’équipe, tracées par chantier',
      text: 'Le module RH & Salaires de Cantia garde un historique clair des heures travaillées par chaque collaborateur, chantier par chantier — une base solide en cas de contrôle.',
