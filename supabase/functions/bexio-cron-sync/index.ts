...
import { syncBexioInvoiceStatuses } from './bexio-sync-logic.ts';
...
// connected and auto_sync_enabled, pulling invoice payment status only.
// Contacts/articles stay manual (button in Compte > Intégrations) for V1.
